...
function GetForecastByHour() {
  ...
  var jqxhr = $.getJSON("https://api.forecast.io/forecast/02a4fe56c45dc599d4befb44dd5aede9/52.9500,1.1333,2014-10-13T09:53:00-0100?callback=?", function (data) {

    // var AMorPM = $('#ihourAMPM :selected').text();
